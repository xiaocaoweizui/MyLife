...
using MyLift.Configuration.Ui;
using MyLift.Sessions;
using MyLift.Web.Models;
using MyLift.Web.Models.Layout;

namespace MyLift.Web.Controllers
{
    public class LayoutController : MyLiftControllerBase
    {
